...
class Notification(models.Model):
    user = models.OneToOneField(Vendor, on_delete=models.SET_NULL, null=True, related_name="vendor_notification")
    type = models.CharField(max_length=50, choices=NOTFICATION_TYPE, null = True, blank = True)
    order = models.ForeignKey("store.OrderItem", on_delete=models.CASCADE, null=True)

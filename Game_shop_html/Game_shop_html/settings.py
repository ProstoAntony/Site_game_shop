...
from Database.DatabaseConfig import DATABASES_CONFIG
...
SECRET_KEY = 'django-insecure-@rx%%w32n-o((wkbob_u8dum5dd)m3qw@*=oo^x(sidhkq64!q'
...
ROOT_URLCONF = 'Game_shop_html.urls'
...
WSGI_APPLICATION = 'Game_shop_html.wsgi.application'
